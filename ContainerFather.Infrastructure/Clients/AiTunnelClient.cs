  ...
  private readonly IOptions<BotConfiguration> _options;
    ...
    public const string Prompt1 = """
                                  ...
                                  public class AiContainerResponse
                                  {
                                      ...
                                      public string? Availability { get; set; } // Опционально: "В наличии", "По запросу"
                                  ...
                                  4. Если в тексте нет данных для обязательного поля — используй значения по умолчанию из правил.  
